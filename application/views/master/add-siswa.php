    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('master/add-siswa'); ?>" method="post">
                        <div class="form-group">
                            <label for="nis">NIS</label>
                            <input type="text" class="form-control <?= form_error('nis') ? 'is-invalid' : ''; ?>" id="nis" name="nis" placeholder="NIS" value="<?= set_value('nis'); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="kelas_id" id="kelas_id">
                                <?php foreach ($kelas as $k) : ?>
                                    <option value="<?= $k->id; ?>" <?= set_value('kelas_id') == $k->id ? 'selected' : ''; ?>><?= $k->name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class=" form-group mb-0">
